...
class TableController extends Controller
{
    ...
    public function conta(Table $mesa)
    {
        $pedidos = Order::where('table_id', $mesa->id)
            ->whereIn('status', ['aberto', 'em_preparo', 'pronto', 'pronto_entrega', 'aguardando_pagamento'])
        ...
        // Conta está fechada se algum pedido está pronto_entrega ou aguardando_pagamento
        $contaFechada = $pedidos->contains(fn($p) => in_array($p->status, ['pronto_entrega', 'aguardando_pagamento']));
